          ...
          mutationList.forEach(function (mutation) {
            if (
              ...
              if (mutation.target.className.includes('is-sticky')) {
                ...
                // fix for logo
                const logoElement = document.querySelector('.it-brand-wrapper.cloned-element .icon');
                ...
                const searchButtonElement = document.querySelector('.it-search-wrapper.cloned-element a.search-link');
                const searchModalElement = document.querySelector('.it-search-wrapper.cloned-element div#modal-header-center-search');
